 ...
 * flag names as keys and evaluated values.
 *
...
class GetAllFlagsTest extends TestCase {
    ...
    public function testLoadDataSingleActiveSwitchFlag(): void {
        $phlag = $this->createPhlag(1, 'feature_checkout', 'SWITCH', 'true');
        $action = new GetAllFlags();
    ...
    public function testLoadDataNullValues(): void {
        $phlags = [
            1 => $this->createPhlag(1, 'null_switch', 'SWITCH', null),
            2 => $this->createPhlag(2, 'null_string', 'STRING', null),
        ];
        ...
        $this->assertNull($result['__raw_value']['null_switch']);
